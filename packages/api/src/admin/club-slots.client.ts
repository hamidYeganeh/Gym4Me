...
import { adminClubSlotsEndpoints as ep } from "./club-slots.endpoint";

/** Admin classes & slots. */
export function createAdminClubSlotsApi(client: ApiClient) {
  return {
...
export type AdminClubSlotsApi = ReturnType<typeof createAdminClubSlotsApi>;
