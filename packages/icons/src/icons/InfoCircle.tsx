...
export const InfoCircle = createIcon(
  ...
  <>
    ...
    <path d="M12.75 17H11.25V11H12.75V17Z" fill="currentColor"/>
    <path d="M12 7C12.6904 7 13.25 7.55964 13.25 8.25C13.25 8.94036 12.6904 9.5 12 9.5C11.3096 9.5 10.75 8.94036 10.75 8.25C10.75 7.55964 11.3096 7 12 7Z" fill="currentColor"/>
