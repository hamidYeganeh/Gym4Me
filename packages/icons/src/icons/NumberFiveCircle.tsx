...
export const NumberFiveCircle = createIcon(
  "NumberFiveCircle",
  "0 0 24 24",
  <>
    <circle cx="12" cy="12" r="9" fill="currentColor" fillOpacity="0.2"/>
    <path d="M14.5 7.25V8.75H10.75V11.25H12.5C14.0188 11.25 15.25 12.4812 15.25 14C15.25 15.5188 14.0188 16.75 12.5 16.75H9.25V15.25H12.5C13.1904 15.25 13.75 14.6904 13.75 14C13.75 13.3096 13.1904 12.75 12.5 12.75H9.25V7.25H14.5Z" fill="currentColor"/>
