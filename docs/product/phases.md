...
| **۲** | کاتالوگ و عرضه           | C، K1، K3، M3، M11، C5، O10، P1، P12، Q8، Q11                             | باشگاه/مربی واقعی، تأییدشده و قابل جست‌وجو                       | 🟡 discovery feed نسخه‌دار با composer ادمین، عرضهٔ عمومی revalidated، pricing پلن bounded، credential/expiry مربی، فیلتر/نقشه و SEO کلاس/شهر؛ CI smoke seed مشترک در VERIFY و K3 جزئی       |
| **۳** | رزرو و دریافت وجه        | D، L1–L3، N1، N3، O1، O5–O7، P3–P4، P6، P9، Q1، R3–R4                     | اولین تراکنش آنلاین/حضوری و حضور قابل اتکا — **هستهٔ MVP**       | 🟡 approval/TTL/idempotency/cancel preview + پرداخت ترکیبی؛ check-in آفلاین signed/ordered محلی `PARTIAL` و device/replica smoke باز است؛ credential واقعی Zarinpal/FCM مانده است |
| **۴** | عضویت + lifecycle        | E، F، L5، K4، O2، O8–O9، O11، O14، P2، Q5، Q12، R5–R9، R12                | فروش/مصرف/تمدید عضویت و جلوگیری از ریزش                          | 🟡 فروش/import پذیرش، پرداخت جزئی/بدهی/Ledger، lifecycle اتمیک، checkout آنلاین عضویت ورزشکار و اشتراک owner با زرین‌پال/reconcile؛ plan-change، grace و enforcement محدودیت اشتراک باز است          |
| **۵** | مربیگری و پیشرفت         | G، H، N4، P5، P10–P11، Q6–Q7                                              | برنامه، لاگ، متریک، self-tracking و بازخورد ایمن                 | 🟡 اجرای جلسه/set/RPE/pain/edit/remove، revision، review+Outbox و offline queue/cache/recovery پیاده شده؛ health/device/replica integration و smoke قطع/وصل واقعی مانده |
