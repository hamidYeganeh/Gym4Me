...
| **۲** | کاتالوگ و عرضه           | C، K1، K3، M3، M11، C5، O10، P1، P12، Q8، Q11                             | باشگاه/مربی واقعی، تأییدشده و قابل جست‌وجو                       | 🟡 discovery feed نسخه‌دار با composer ادمین، infinite scroll و targeting علایق؛ وب‌سایت و فیلتر Q11؛ K3 جزئی       |
