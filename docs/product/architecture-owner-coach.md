...
قاعدهٔ مرزبندی: «چه کسی خدمت را عرضه می‌کند» در `account/*` است، «موشمارهای مشترک بین نقش‌ها» (رزرو، مالی، اعلان) ماژول top-level هستند و هیچ منطق نقش‌محوری داخل خودشان ندارند — سیاست نقش/مجوز در Guard و سرویس فراخوان اعمال می‌شود.
