...
export const seoCoachesListScreenVariants = tv({
  slots: {
    ...
    searchInput:
      "min-h-11 min-w-0 flex-1 rounded-2xl border border-border bg-surface px-4 py-3 text-base",
    searchButton:
      "min-h-11 rounded-2xl bg-accent px-5 py-3 font-semibold text-accent-foreground sm:w-auto",
    ...
    cardTitle: "min-w-0 text-xl font-semibold",
    badge: "shrink-0 rounded-full bg-success/10 px-3 py-1 text-xs text-success",
