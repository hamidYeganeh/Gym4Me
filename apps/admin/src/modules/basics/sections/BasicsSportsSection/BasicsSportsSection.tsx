      ...
      <section className={styles.intro()}>
        ...
        <div className={styles.introActions()}>
          ...
          <Button
            ...
            onPress={() =>
              navigate(
                `${routes.sportNew(kind)}${parentId ? `?parentId=${parentId}` : ""}`,
              )
            }
          >
            <Plus size={18} />
                        ...
                        <Table.Cell>
                          <div className={styles.actionsCell()}>
                            <Button
                              ...
                              variant="tertiary"
                              onPress={() =>
                                navigate(routes.sportEdit(kind, item.id))
                              }
                            >
                              <Pencil1 size={16} />
                              {t("edit")}
      ...
      <AlertDialog>
        ...
        >
          <AlertDialog.Container>
            <AlertDialog.Dialog>
              <AlertDialog.Header>
                <AlertDialog.Heading>{t("sports.deleteTitle")}</AlertDialog.Heading>
              </AlertDialog.Header>
              <AlertDialog.Body>
                <Typography>{t("sports.deleteBody")}</Typography>
              </AlertDialog.Body>
              <AlertDialog.Footer>
