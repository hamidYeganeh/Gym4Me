...
import { articleCoverFieldVariants } from "./ArticleCoverField.styles";
import type { ArticleCoverFieldProps } from "./ArticleCoverField.types";
...
export function ArticleCoverField({
  ...
  const styles = articleCoverFieldVariants();
