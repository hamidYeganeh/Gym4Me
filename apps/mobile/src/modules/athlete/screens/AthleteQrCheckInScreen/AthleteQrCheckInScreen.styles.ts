...
export const athleteQrCheckInScreenVariants = tv({
  slots: {
    ...
    qrCard:
      "flex flex-col items-center gap-4 rounded-[1.5rem] border-0 bg-surface p-6 text-center shadow-sm shadow-foreground/5",
    qrPlaceholder:
    ...
    row: "flex flex-col gap-1 rounded-[1.25rem] border-0 bg-surface px-4 py-3 shadow-sm shadow-foreground/5",
