...
export const coachMessagesScreenVariants = tv({
  slots: {
    root: "bg-background",
    ...
    item: "flex w-full items-center gap-3 rounded-[1.25rem] border-0 bg-surface px-4 py-3 text-start shadow-sm shadow-foreground/5",
    itemIcon:
...
export type CoachMessagesScreenVariants = VariantProps<
  typeof coachMessagesScreenVariants
>;
