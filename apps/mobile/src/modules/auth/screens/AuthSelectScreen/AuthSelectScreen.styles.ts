...
export const authSelectScreenVariants = tv({
  slots: {
    ...
    biometricButton: [
      ...
      "rounded-none bg-transparent text-white shadow-none",
      "data-[hovered=true]:bg-transparent data-[hovered=true]:text-white/80",
    ...
    biometricFrame: "absolute inset-0 !size-40 text-white",
