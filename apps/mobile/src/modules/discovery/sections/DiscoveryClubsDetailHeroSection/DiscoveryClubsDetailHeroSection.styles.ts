export const discoveryClubsDetailHeroSectionStyles = {
  ...
  title:
    "text-balance text-[1.75rem] leading-tight text-white drop-shadow-sm",
  locationRow: "mt-2 flex items-center gap-1.5 text-white",
  locationText: "truncate text-white/95",
  ...
  thumbActive: "border-white opacity-100",
  thumbIdle: "border-white/80 opacity-90",
  thumbImage: "object-cover",
  sheet:
    "relative z-10 -mt-10 min-h-[calc(42dvh+2.5rem)] rounded-t-[2.5rem] bg-surface",
} as const;
