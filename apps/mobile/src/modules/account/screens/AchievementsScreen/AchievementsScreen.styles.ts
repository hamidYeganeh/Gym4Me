...
export const achievementsScreenVariants = tv({
  slots: {
    ...
    summaryStats: "flex items-stretch justify-around gap-2 border-t border-border pt-4",
    ...
    gridItem:
      "flex flex-col items-center gap-2 rounded-[20px] border border-border bg-surface p-3 text-center",
    ...
    historyAmountPositive: "shrink-0 text-sm font-bold tabular-nums text-success",
    historyAmountNegative: "shrink-0 text-sm font-bold tabular-nums text-danger",
