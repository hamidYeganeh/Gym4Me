...
export const ownerClubsCreateLocationChoiceSheetVariants = tv({
  slots: {
...
export type OwnerClubsCreateLocationChoiceSheetVariants = VariantProps<
  typeof ownerClubsCreateLocationChoiceSheetVariants
>;
