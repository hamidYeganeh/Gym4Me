export const ownerHomeTasksOverviewSectionStyles = {
  ...
  primaryCard: "relative col-span-2 overflow-hidden -[28px] border-0 bg-stats-blue text-stats-foreground shadow-none",
  primaryDecor: "pointer-events-none absolute inset-y-4 end-4 flex gap-2",
  primaryBar: "h-full w-3 bg-stats-foreground/15 first:opacity-100 [&:nth-child(2)]:opacity-70 last:opacity-40",
  primaryHeader: "relative z-10 flex items-start justify-between gap-3",
  primaryLabel: "text-stats-foreground/95",
  primaryAction: "shrink-0 bg-accent text-accent-foreground shadow-none",
  ...
  secondaryCard:
    "flex min-h-[168px] flex-col justify-between overflow-hidden rounded-[28px] border-0 p-4",
  upcomingCard:
