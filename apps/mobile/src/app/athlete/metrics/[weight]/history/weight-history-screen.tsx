...
import { formatTimeFa, formatWeightKg, toPersianDigits } from "../lib/format";
...
export function WeightHistoryScreen({ metric }: WeightHistoryScreenProps) {
