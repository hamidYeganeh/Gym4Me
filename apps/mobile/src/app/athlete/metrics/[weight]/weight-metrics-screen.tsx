...
import { getRecentWeightHistory } from "./lib/weight-history-data";

type PeriodKey = "1d" | "1w" | "1m" | "1y" | "all";

type WeightMetricsScreenProps = {
  metric: MetricSlug;
};
...
export function WeightMetricsScreen({ metric }: WeightMetricsScreenProps) {
