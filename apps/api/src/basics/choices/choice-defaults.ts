...
export const DEFAULT_CHOICE_GROUPS: ChoiceSeed[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'loseWeight', name: 'کاهش وزن و چربی‌سوزی', order: 5 },
      { value: 'gainMuscle', name: 'عضله‌سازی', order: 6 },
      { value: 'buildStrength', name: 'افزایش قدرت', order: 7 },
      { value: 'improveEndurance', name: 'افزایش استقامت', order: 8 },
      { value: 'improveFlexibility', name: 'افزایش انعطاف‌پذیری', order: 9 },
      { value: 'improvePosture', name: 'اصلاح فرم بدن و پاسچر', order: 10 },
      { value: 'prepareCompetition', name: 'آمادگی برای مسابقه', order: 11 },
      { value: 'learnSport', name: 'یادگیری یک رشته ورزشی', order: 12 },
      { value: 'returnToSport', name: 'بازگشت به ورزش پس از آسیب', order: 13 },
      { value: 'reduceStress', name: 'کاهش استرس و بهبود خواب', order: 14 },
      {
        value: 'stayActive',
        name: 'حفظ تناسب اندام و فعالیت روزانه',
        order: 15,
      },
    ],
  },
