...
export enum AuditAction {
  ...
  DISCOVERY_PAGE_DRAFT_UPDATED = 'discovery.page_draft_updated',
  DISCOVERY_PAGE_PUBLISHED = 'discovery.page_published',
  DISCOVERY_PAGE_ROLLED_BACK = 'discovery.page_rolled_back',
